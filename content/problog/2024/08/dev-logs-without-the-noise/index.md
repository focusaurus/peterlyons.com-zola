...
The exact filters and selects will need to be tailored for your specific logs, but a project I recently worked on had things roughly as below that were usually noise I wanted to hide.
...
To use this, pipe your server's json log output to this script. You can throw `tee` in the pipeline too if you want the full unfiltered log to disk, but the pretty version in your terminal.
