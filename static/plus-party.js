...
var _focusaurus$code$Core$parseFloat = function (match) {
	return _elm_lang$core$Result$toMaybe(
		_elm_lang$core$String$toFloat(match.match));
};
var _focusaurus$code$Core$numberRe = _elm_lang$core$Regex$regex('\\b-?(\\d{1,3}(,\\d{3})*|\\d+)(\\.\\d+)?\\b');
var _focusaurus$code$Core$dateRe = _elm_lang$core$Regex$regex('\\b\\d{1,2}\\/\\d{1,2}\\/(\\d{2}|\\d{4})\\b');
var _focusaurus$code$Core$commaRe = _elm_lang$core$Regex$regex(',');
var _focusaurus$code$Core$parseNumbers = function (rawText) {
	var noDates = A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_focusaurus$code$Core$dateRe,
		_elm_lang$core$Basics$always(''),
		rawText);
	var noCommas = A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_focusaurus$code$Core$commaRe,
		_elm_lang$core$Basics$always(''),
		noDates);
	return A2(
		_elm_lang$core$List$filterMap,
		_focusaurus$code$Core$parseFloat,
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _focusaurus$code$Core$numberRe, noCommas));
};
...
var _focusaurus$code$PlusParty$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _focusaurus$code$PlusParty$buttonText = function (copying) {
	var _p0 = copying;
	if (_p0 === true) {
		return _elm_lang$core$Json_Encode$string('Copied!');
	} else {
		return _elm_lang$core$Json_Encode$string('Copy Total &#x1F4CB;');
	}
};
var _focusaurus$code$PlusParty$later = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		function (_p1) {
			return msg;
...
var _focusaurus$code$PlusParty$item = function (fixed) {
	return A2(
...
var _focusaurus$code$PlusParty$fix2 = _myrho$elm_round$Round$round(2);
var _focusaurus$code$PlusParty$getParty = function (model) {
	var numbers = _focusaurus$code$Core$parseNumbers(model.text);
	var total = _elm_lang$core$List$sum(numbers);
	return {
		numbers: A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, numbers),
		totalFixed: _focusaurus$code$PlusParty$fix2(total)
	};
};
var _focusaurus$code$PlusParty$initialText = 'Paste some numbers in here and we\'ll total them up even if there\'s some words and junk, too.\n\nFor example: 1 plus 2 plus 2 plus 1\n';
var _focusaurus$code$PlusParty$init = {
	ctor: '_Tuple2',
	_0: {text: _focusaurus$code$PlusParty$initialText, copying: false},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _focusaurus$code$PlusParty$Model = F2(
	function (a, b) {
		return {text: a, copying: b};
	});
var _focusaurus$code$PlusParty$Party = F2(
	function (a, b) {
		return {numbers: a, totalFixed: b};
	});
var _focusaurus$code$PlusParty$CopyTotal = function (a) {
	return {ctor: 'CopyTotal', _0: a};
};
var _focusaurus$code$PlusParty$update = F2(
	function (message, model) {
		var _p2 = message;
		if (_p2.ctor === 'ChangeInput') {
			return {
				ctor: '_Tuple2',
			...
			return {
				...
				_1: function () {
					var _p3 = _p4;
					if (_p3 === true) {
						return _focusaurus$code$PlusParty$later(
							_focusaurus$code$PlusParty$CopyTotal(false));
					} else {
...
var _focusaurus$code$PlusParty$ChangeInput = function (a) {
	return {ctor: 'ChangeInput', _0: a};
};
var _focusaurus$code$PlusParty$view = function (model) {
	var party = _focusaurus$code$PlusParty$getParty(model);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('plus-party'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_focusaurus$code$PlusParty$ChangeInput),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('copy-total'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_focusaurus$code$PlusParty$CopyTotal(true)),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-clipboard-text', party.totalFixed),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html_Attributes$property,
										'innerHTML',
										_focusaurus$code$PlusParty$buttonText(model.copying)),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						...
						A2(_elm_lang$core$List$map, _focusaurus$code$PlusParty$item, party.numbers)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(party.totalFixed),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _focusaurus$code$PlusParty$main = _elm_lang$html$Html$program(
	{init: _focusaurus$code$PlusParty$init, view: _focusaurus$code$PlusParty$view, update: _focusaurus$code$PlusParty$update, subscriptions: _focusaurus$code$PlusParty$subscriptions})();

var Elm = {};
Elm['PlusParty'] = Elm['PlusParty'] || {};
if (typeof _focusaurus$code$PlusParty$main !== 'undefined') {
    _focusaurus$code$PlusParty$main(Elm['PlusParty'], 'PlusParty', undefined);
}
